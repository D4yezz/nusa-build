...
export const projectsData: ProjectItem[] = [
  {
    ...
    specs: [
      { id: "Struktur: Beton Bertulang Mutu Tinggi (K-600) & Steel Frame", en: "Structure: High-Strength Reinforced Concrete (K-600) & Steel Frame" },
      { id: "Sertifikasi: Greenship Platinum GBCI", en: "Certification: Greenship Platinum GBCI" },
      { id: "Fasilitas: Helipad, Double Deck Elevator, Underground Parking 400 Mobil", en: "Facilities: Helipad, Double Deck Elevator, Underground Parking 400 Cars" }
    ]
  },
  {
    ...
    specs: [
      { id: "Struktur: Pondasi Footplate Anti Gempa & Rangka Baja Ringan Premium", en: "Structure: Earthquake Resistant Footplate Foundation & Premium Light Steel Frame" },
      { id: "Material: Kayu Ulin Kalimantan, Batu Paras Jogja, Kaca Low-E", en: "Materials: Kalimantan Ulin Wood, Jogja Paras Stone, Low-E Glass" },
      { id: "Fitur: Smart Home Automation, Solar Panel 10kW, Natural Ventilation System", en: "Features: Smart Home Automation, Solar Panel 10kW, Natural Ventilation System" }
    ]
  },
  {
    ...
    specs: [
      { id: "Gaya: Industrial Biophilic & Warm Modern Wood Accent", en: "Style: Industrial Biophilic & Warm Modern Wood Accent" },
      { id: "Akustik: Soundproofing Panel NRC 0.85 di Seluruh Ruang Rapat", en: "Acoustics: Soundproofing Panel NRC 0.85 in All Meeting Rooms" },
      { id: "Pencahayaan: Custom Architectural Linear LED (CRI > 90)", en: "Lighting: Custom Architectural Linear LED (CRI > 90)" }
    ]
  },
  {
    ...
    specs: [
      { id: "Fasad: Aluminum Composite Panel (ACP) High-Grade & Curved Tempered Glass", en: "Facade: High-Grade Aluminum Composite Panel (ACP) & Curved Tempered Glass" },
      { id: "Struktur: Column-Free Atrium Span 24 meter", en: "Structure: Column-Free Atrium Span 24 meters" }
    ]
  },
  {
    ...
    specs: [
      { id: "Struktur: Bored Pile & Cantilever Slab", en: "Structure: Bored Pile & Cantilever Slab" },
      { id: "Keberlanjutan: Rainwater Harvesting System 5.000L & Solar PV 8kW", en: "Sustainability: Rainwater Harvesting System 5,000L & Solar PV 8kW" }
    ]
  },
  {
    ...
    specs: [
      { id: "Material: Marmer Italian Calacatta Gold & Natural Walnut Veneer", en: "Materials: Italian Calacatta Gold Marble & Natural Walnut Veneer" },
      { id: "Pencahayaan: DALI Dimming System with Preset Scene Control", en: "Lighting: DALI Dimming System with Preset Scene Control" }
    ]
  }
];
