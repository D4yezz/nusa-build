...
export const servicesData: ServiceItem[] = [
  {
    ...
    features: {
      id: ["Gedung Perkantoran & HQ", "Pusat Perbelanjaan & Retail", "Hotel & Resor Komersial", "Ruko & Ruang Usaha Modern"],
      en: ["Office Buildings & Headquarters", "Shopping & Retail Centers", "Hotels & Commercial Resorts", "Shophouses & Modern Business Spaces"]
    },
  ...
  },
  {
    ...
    features: {
      id: ["Konsep Arsitektur 3D Render", "Desain Tata Ruang Interior", "Pemilihan Material & Moodboard", "Lighting & Acoustic Design"],
      en: ["3D Render Architectural Concepts", "Interior Layout & Space Planning", "Material & Moodboard Selection", "Lighting & Acoustic Design"]
    },
  ...
  },
  {
    ...
    features: {
      id: ["Penguatan Struktur Anti-Gempa", "Remodelling Fasad & Exterior", "Penambahan Lantai & Perluasan", "Retrofitting Material Modern"],
      en: ["Seismic Structural Retrofitting", "Exterior & Facade Remodelling", "Floor Addition & Expansion", "Modern Material Upgrades"]
    },
  ...
  },
  {
    ...
    features: {
      id: ["Supervisi Kualitas Konstruksi", "Audit Anggaran RAB & Material", "Manajemen Keselamatan K3LH", "Laporan Kemajuan Proyek Real-time"],
      en: ["Construction Quality Supervision", "BOQ & Material Budget Audit", "HSE Safety Management", "Real-Time Project Progress Reports"]
    },
